...
### Instalação no Dia 1 (funciona em todos os sistemas)
```r
# Pacotes principais
install.packages(c("tidyverse", "here", "janitor", "skimr", 
                   "readxl", "writexl", "rmarkdown", "usethis",
                   "gitcreds"))
```

### Instalação no Dia 4 (integração com IA)
```r
# Ferramentas de IA
install.packages(c("gptstudio", "chattr", "httr2"))
```

**Nota:** A instalação de pacotes é idêntica em todos os sistemas operacionais.
...
### Boas Práticas e Debugging (25min)
- **Naming conventions:** `snake_case`
- **Comentários eficientes**
- **Lendo mensagens de erro**
- **IA como assistente:** ChatGPT vs Claude
- Uso ético: sempre entender o código
...
### Verbos Essenciais do dplyr (50min)
...
**Nota:** Ambos os pipes funcionam em todos os sistemas!

### Exemplo Integrado (25min)
- Dataset: dados de saúde pública ou agricultura
- Pipeline completo com todos os verbos
- **Prática:** criar pipeline com dados reais
...
**Commit:** `git commit -m "Transformação e I/O - Dia 3"`
...
**Formatos suportados em todos os sistemas:**
- PNG: melhor para relatórios e web
- PDF: melhor para publicações científicas
- JPEG: comprimido, menor qualidade
...
# Dia 4: 25/11 (Terça) - RMarkdown e Integração IA no RStudio
...
## 20h50 - 22h00 | Integração de IA no RStudio
...
**Versão:** 5.0 - Com instruções completas de Fork